...
3.  **Set up the environment**:
    ...
    pip install -e .
    ```
4.  **Familiarize yourself with the project**: See [Project Structure](README.md#project-structure) and [Documentation](README.md#documentation) in the main README.
...
- Update `README.md` and documentation in `docs/` (e.g. `docs/QUICKSTART.md`, `docs/AI.md`) and any `src/*/README.md` if your changes affect usage or setup.

## Testing

- All new features **must** be accompanied by unit tests.
- We use `pytest` for testing.
- Place tests in `tests/unit/` or `tests/integration/` matching the source structure (e.g. `tests/unit/test_detectors.py` for `src/perception/detectors/`).
