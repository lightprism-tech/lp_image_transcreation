...
### Script location
- **`scripts/knowledge_graph/generator.py`** – generation script
- **`scripts/knowledge_graph/countries.json`** – source country/culture data (edit here)
...
The script writes the knowledge graph into **`data/knowledge_base/`** in three formats:
