...
def test_perception_main_entry_point():
    """Test that perception.main entry point (replaces perception.core.pipeline) can be imported."""
    pytest.importorskip("ultralytics", reason="perception.main requires ML dependencies")
